              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.edit, size: 18, color: StandbyColors.primary),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: StandbyColors.primary, width: 3),
              ),
              child: ClipOval(
                child: Image.file(
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      shape: BoxShape.circle,
                      color: StandbyColors.primarySoft,
                      border: Border.all(color: StandbyColors.primary, width: 1),
                    ),
                    child: Center(
                      child: Icon(
